...
axs[0].plot(time, imu_px4["angular_velocity.x"] - gt_gyro[0, :], label="Measurement Error")
axs[1].plot(time, imu_px4["angular_velocity.y"] - gt_gyro[1, :], label="Measurement Error")
axs[2].plot(time, imu_px4["angular_velocity.z"] - gt_gyro[2, :], label="Measurement Error")
...
axs[0].plot(time, imu_px4["linear_acceleration.x"] - gt_accelerometer[0, :], label="Measurement Error")
axs[1].plot(time, imu_px4["linear_acceleration.y"] - gt_accelerometer[1, :], label="Measurement Error")
axs[2].plot(time, imu_px4["linear_acceleration.z"] - gt_accelerometer[2, :], label="Measurement Error")
